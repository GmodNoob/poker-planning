...
export default function Room() {
  ...
  const { roomState, roomInfo, error, isConnected, join, vote, reveal, reset, removeMember, refetchInfo } = useRoom(code)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-4">
        ...
        {/* Voting cards */}
        <div className="mb-6">
          <h3 className="text-sm font-medium text-purple-200 mb-3 text-center">Your vote:</h3>
        ...
        {showResults && members.length > 0 && (
          <div className="bg-white/5 rounded-xl p-4 mb-4">
            ...
            {numericVotes.length > 0 && (
              <div className="text-center mb-4">
                <p className="text-purple-200">
                  Average: <span className="font-bold text-white text-2xl">{average.toFixed(1)}</span>
                </p>
              </div>
            )}
            ...
            {(() => {
              ...
              if (voteCounts.size === 0 || totalVoters < 3 || voteCounts.size === 1) return null
